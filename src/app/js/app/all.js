...
require('./_breakpoints.js.js');
require('./_gridalicious.js.js');
require('./_scrollable.js.js');
require('./_skins');
require('./_isotope');
require('./_parallax');
...
var library = require('./_library.js.js')();

// Holds google maps styles
var styles = {
    "light-grey": require('./styles/_light-grey.js.js'),
    "light-monochrome": require('./styles/_light-monochrome.js.js'),
    "cool-grey": require('./styles/_cool-grey.js.js'),
    "blue-gray": require('./styles/_blue-gray.js.js'),
    "paper": require('./styles/_paper.js.js'),
    "apple": require('./styles/_apple.js.js'),
    "light-green": require('./styles/_light-green.js.js'),
    "lemon-tree": require('./styles/_lemon-tree.js.js'),
    "clean-cut": require('./styles/_clean-cut.js.js'),
    "nature": require('./styles/_nature.js.js')
};
